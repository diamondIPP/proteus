...
h1 = ROOT.gDirectory.Get("DUTPlane0MapC")
...
h1.GetPaintedHistogram().GetYaxis().SetRangeUser(1600, 2550)
...
h1.GetPaintedHistogram().GetXaxis().SetRangeUser(400, 1850)
...
tex3.Draw("Same")
tex4.Draw("Same")
c1.Print("/Users/javierb/Desktop/GlobalEff/GlobalEff_404.pdf","pdf")
