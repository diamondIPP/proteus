...
SRCPATH = src
EXECUTABLE = Judith
OBJECTS = $(OBJPATH)/exception.o $(OBJPATH)/configparser.o $(OBJPATH)/main.o $(OBJPATH)/inputargs.o $(OBJPATH)/clustermaker.o $(OBJPATH)/processors.o $(OBJPATH)/largesynchronizer.o $(OBJPATH)/trackmatcher.o $(OBJPATH)/eventdepictor.o $(OBJPATH)/trackmaker.o $(OBJPATH)/configprocessors.o $(OBJPATH)/synchronizer.o $(OBJPATH)/looper.o $(OBJPATH)/analysisdut.o $(OBJPATH)/applymask.o $(OBJPATH)/processevents.o $(OBJPATH)/coarsealigndut.o $(OBJPATH)/finealigndut.o $(OBJPATH)/configloopers.o $(OBJPATH)/synchronize.o $(OBJPATH)/examplelooper.o $(OBJPATH)/noisescan.o $(OBJPATH)/analysis.o $(OBJPATH)/coarsealign.o $(OBJPATH)/finealign.o $(OBJPATH)/plane.o $(OBJPATH)/cluster.o $(OBJPATH)/event.o $(OBJPATH)/hit.o $(OBJPATH)/track.o $(OBJPATH)/storageio.o $(OBJPATH)/configanalyzers.o $(OBJPATH)/examplesingleanalyzer.o $(OBJPATH)/efficiency.o $(OBJPATH)/depiction.o $(OBJPATH)/baseanalyzer.o $(OBJPATH)/correlation.o $(OBJPATH)/matching.o $(OBJPATH)/residuals.o $(OBJPATH)/dutdepiction.o $(OBJPATH)/dualanalyzer.o $(OBJPATH)/eventinfo.o $(OBJPATH)/dutcorrelation.o $(OBJPATH)/hitinfo.o $(OBJPATH)/exampledualanalyzer.o $(OBJPATH)/dutresiduals.o $(OBJPATH)/trackinfo.o $(OBJPATH)/occupancy.o $(OBJPATH)/singleanalyzer.o $(OBJPATH)/syncfluctuation.o $(OBJPATH)/clusterinfo.o $(OBJPATH)/kartelconvert.o $(OBJPATH)/alignment.o $(OBJPATH)/device.o $(OBJPATH)/configmechanics.o $(OBJPATH)/noisemask.o $(OBJPATH)/sensor.o 
...
$(OBJPATH)/exception.o: $(SRCPATH)/exception.cpp
	$(CC) $(CFLAGS) -c $(SRCPATH)/exception.cpp -o $(OBJPATH)/exception.o
...
$(OBJPATH)/baseanalyzer.o: $(SRCPATH)/analyzers/baseanalyzer.cpp
	$(CC) $(CFLAGS) -c $(SRCPATH)/analyzers/baseanalyzer.cpp -o $(OBJPATH)/baseanalyzer.o
