...
SRCPATH = src
EXECUTABLE = Judith
OBJECTS = $(OBJPATH)/configparser.o $(OBJPATH)/inputargs.o $(OBJPATH)/main.o $(OBJPATH)/event.o $(OBJPATH)/plane.o $(OBJPATH)/track.o $(OBJPATH)/hit.o $(OBJPATH)/cluster.o $(OBJPATH)/storageio.o $(OBJPATH)/kartelconvert.o $(OBJPATH)/syncfluctuation.o $(OBJPATH)/efficiency.o $(OBJPATH)/residuals.o $(OBJPATH)/correlation.o $(OBJPATH)/dutcorrelation.o $(OBJPATH)/singleanalyzer.o $(OBJPATH)/dualanalyzer.o $(OBJPATH)/dutresiduals.o $(OBJPATH)/eventinfo.o $(OBJPATH)/clusterinfo.o $(OBJPATH)/examplesingleanalyzer.o $(OBJPATH)/depiction.o $(OBJPATH)/hitinfo.o $(OBJPATH)/exampledualanalyzer.o $(OBJPATH)/matching.o $(OBJPATH)/trackinfo.o $(OBJPATH)/occupancy.o $(OBJPATH)/configanalyzers.o $(OBJPATH)/dutdepiction.o $(OBJPATH)/synchronizer.o $(OBJPATH)/trackmaker.o $(OBJPATH)/trackmatcher.o $(OBJPATH)/processors.o $(OBJPATH)/configprocessors.o $(OBJPATH)/eventdepictor.o $(OBJPATH)/clustermaker.o $(OBJPATH)/largesynchronizer.o $(OBJPATH)/sensor.o $(OBJPATH)/alignment.o $(OBJPATH)/configmechanics.o $(OBJPATH)/device.o $(OBJPATH)/noisemask.o $(OBJPATH)/coarsealigndut.o $(OBJPATH)/noisescan.o $(OBJPATH)/finealigndut.o $(OBJPATH)/coarsealign.o $(OBJPATH)/analysis.o $(OBJPATH)/configloopers.o $(OBJPATH)/synchronize.o $(OBJPATH)/processevents.o $(OBJPATH)/analysisdut.o $(OBJPATH)/examplelooper.o $(OBJPATH)/finealign.o $(OBJPATH)/looper.o $(OBJPATH)/applymask.o 
