...
SRCPATH = src
EXECUTABLE = Judith
OBJECTS = $(OBJPATH)/main.o $(OBJPATH)/inputargs.o $(OBJPATH)/configparser.o $(OBJPATH)/cluster.o $(OBJPATH)/hit.o $(OBJPATH)/storageio.o $(OBJPATH)/event.o $(OBJPATH)/plane.o $(OBJPATH)/track.o $(OBJPATH)/syncfluctuation.o $(OBJPATH)/dutcorrelation.o $(OBJPATH)/residuals.o $(OBJPATH)/dutdepiction.o $(OBJPATH)/singleanalyzer.o $(OBJPATH)/efficiency.o $(OBJPATH)/eventinfo.o $(OBJPATH)/clusterinfo.o $(OBJPATH)/exampledualanalyzer.o $(OBJPATH)/depiction.o $(OBJPATH)/examplesingleanalyzer.o $(OBJPATH)/matching.o $(OBJPATH)/configanalyzers.o $(OBJPATH)/correlation.o $(OBJPATH)/hitinfo.o $(OBJPATH)/occupancy.o $(OBJPATH)/trackinfo.o $(OBJPATH)/dutresiduals.o $(OBJPATH)/dualanalyzer.o $(OBJPATH)/largesynchronizer.o $(OBJPATH)/trackmaker.o $(OBJPATH)/clustermaker.o $(OBJPATH)/processors.o $(OBJPATH)/configprocessors.o $(OBJPATH)/synchronizer.o $(OBJPATH)/eventdepictor.o $(OBJPATH)/trackmatcher.o $(OBJPATH)/noisemask.o $(OBJPATH)/sensor.o $(OBJPATH)/configmechanics.o $(OBJPATH)/alignment.o $(OBJPATH)/device.o $(OBJPATH)/kartelconvert.o $(OBJPATH)/applymask.o $(OBJPATH)/analysisdut.o $(OBJPATH)/finealign.o $(OBJPATH)/examplelooper.o $(OBJPATH)/finealigndut.o $(OBJPATH)/processevents.o $(OBJPATH)/synchronize.o $(OBJPATH)/coarsealigndut.o $(OBJPATH)/analysis.o $(OBJPATH)/configloopers.o $(OBJPATH)/looper.o $(OBJPATH)/noisescan.o $(OBJPATH)/coarsealign.o 
