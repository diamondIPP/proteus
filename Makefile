...
SRCPATH = src
EXECUTABLE = Judith
OBJECTS = $(OBJPATH)/inputargs.o $(OBJPATH)/configparser.o $(OBJPATH)/exception.o $(OBJPATH)/main.o $(OBJPATH)/processors.o $(OBJPATH)/synchronizer.o $(OBJPATH)/trackmaker.o $(OBJPATH)/trackmatcher.o $(OBJPATH)/largesynchronizer.o $(OBJPATH)/eventdepictor.o $(OBJPATH)/clustermaker.o $(OBJPATH)/configprocessors.o $(OBJPATH)/track.o $(OBJPATH)/event.o $(OBJPATH)/plane.o $(OBJPATH)/hit.o $(OBJPATH)/cluster.o $(OBJPATH)/storageio.o $(OBJPATH)/kartelconvert.o $(OBJPATH)/dutcorrelation.o $(OBJPATH)/dualanalyzer.o $(OBJPATH)/dutresiduals.o $(OBJPATH)/baseanalyzer.o $(OBJPATH)/correlation.o $(OBJPATH)/examplesingleanalyzer.o $(OBJPATH)/configanalyzers.o $(OBJPATH)/eventinfo.o $(OBJPATH)/efficiency.o $(OBJPATH)/exampledualanalyzer.o $(OBJPATH)/residuals.o $(OBJPATH)/clusterinfo.o $(OBJPATH)/singleanalyzer.o $(OBJPATH)/hitinfo.o $(OBJPATH)/occupancy.o $(OBJPATH)/trackinfo.o $(OBJPATH)/dutdepiction.o $(OBJPATH)/syncfluctuation.o $(OBJPATH)/matching.o $(OBJPATH)/depiction.o $(OBJPATH)/device.o $(OBJPATH)/alignment.o $(OBJPATH)/configmechanics.o $(OBJPATH)/noisemask.o $(OBJPATH)/sensor.o $(OBJPATH)/noisescan.o $(OBJPATH)/finealigndut.o $(OBJPATH)/coarsealign.o $(OBJPATH)/coarsealigndut.o $(OBJPATH)/configloopers.o $(OBJPATH)/processevents.o $(OBJPATH)/analysis.o $(OBJPATH)/analysisdut.o $(OBJPATH)/applymask.o $(OBJPATH)/synchronize.o $(OBJPATH)/examplelooper.o $(OBJPATH)/looper.o $(OBJPATH)/finealign.o 
