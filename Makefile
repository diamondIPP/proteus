...
SRCPATH = src
EXECUTABLE = Judith
OBJECTS = $(OBJPATH)/exception.o $(OBJPATH)/main.o $(OBJPATH)/inputargs.o $(OBJPATH)/configparser.o $(OBJPATH)/finealigndut.o $(OBJPATH)/analysisdut.o $(OBJPATH)/looper.o $(OBJPATH)/noisescan.o $(OBJPATH)/configloopers.o $(OBJPATH)/synchronize.o $(OBJPATH)/processevents.o $(OBJPATH)/applymask.o $(OBJPATH)/analysis.o $(OBJPATH)/finealign.o $(OBJPATH)/coarsealign.o $(OBJPATH)/coarsealigndut.o $(OBJPATH)/examplelooper.o $(OBJPATH)/sensor.o $(OBJPATH)/configmechanics.o $(OBJPATH)/alignment.o $(OBJPATH)/noisemask.o $(OBJPATH)/device.o $(OBJPATH)/dutcorrelation.o $(OBJPATH)/matching.o $(OBJPATH)/occupancy.o $(OBJPATH)/trackinfo.o $(OBJPATH)/syncfluctuation.o $(OBJPATH)/dutdepiction.o $(OBJPATH)/depiction.o $(OBJPATH)/exampledualanalyzer.o $(OBJPATH)/examplesingleanalyzer.o $(OBJPATH)/singleanalyzer.o $(OBJPATH)/correlation.o $(OBJPATH)/efficiency.o $(OBJPATH)/eventinfo.o $(OBJPATH)/configanalyzers.o $(OBJPATH)/hitinfo.o $(OBJPATH)/clusterinfo.o $(OBJPATH)/baseanalyzer.o $(OBJPATH)/dutresiduals.o $(OBJPATH)/dualanalyzer.o $(OBJPATH)/residuals.o $(OBJPATH)/kartelconvert.o $(OBJPATH)/clustermaker.o $(OBJPATH)/eventdepictor.o $(OBJPATH)/trackmaker.o $(OBJPATH)/configprocessors.o $(OBJPATH)/synchronizer.o $(OBJPATH)/processors.o $(OBJPATH)/trackmatcher.o $(OBJPATH)/largesynchronizer.o $(OBJPATH)/hit.o $(OBJPATH)/cluster.o $(OBJPATH)/storageio.o $(OBJPATH)/plane.o $(OBJPATH)/event.o $(OBJPATH)/track.o 
