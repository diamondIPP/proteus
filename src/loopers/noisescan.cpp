...
void NoiseScan::setBottomLimitX(unsigned int bottomLimitX) { _bottomLimitX = bottomLimitX; }
void NoiseScan::setUpperLimitX(unsigned int upperLimitX) { _upperLimitX = upperLimitX; }
void NoiseScan::setBottomLimitY(unsigned int bottomLimitY) { _bottomLimitY = bottomLimitY; }
void NoiseScan::setUpperLimitY(unsigned int upperLimitY) { _upperLimitY = upperLimitY; }
