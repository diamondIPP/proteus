...
pt-align ${flags} -u dut_coarse -g output/${dataset}-2/${dataset}-align_tel_fine-geo.toml \
  -m output/${dataset}-2/${dataset}-noisescan-mask.toml \
  ${datadir}/${dataset}.root output/${dataset}-2/${dataset}-align_dut_coarse
  
pt-align ${flags} -u dut_fine -g output/${dataset}-2/${dataset}-align_dut_coarse-geo.toml \
  -m output/${dataset}-2/${dataset}-noisescan-mask.toml \
